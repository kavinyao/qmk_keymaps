...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  MY_UP,    DF(_GL),
        KC_LCTL,  KC_LGUI,  KC_LALT,                                KC_SPC,                                 KC_RALT,  MY_LEFT,  MY_DOWN,  MY_RGHT
    ),
    [_WL] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  DF(_BL),
    ...
    [_GL] = LAYOUT_60_ansi_split_bs_rshift(
        ...
        _______,  XXXXXXX,  XXXXXXX,                                KC_SPC,                                 _______,  _______,  _______,  _______
    ),
